<?php 
if (!class_exists('uxde_user_review')) {
    class uxde_user_review
    {
        ...
        function __construct()
        {
            ...
            add_action('wp_ajax_uxde_rating', array(&$this, 'sync_rating'));
            add_action('wp_ajax_nopriv_uxde_rating', array(&$this, 'sync_rating'));
        ...
        public function load_scripts()
        {
          global $post;
          if ($post) {
                wp_localize_script('jquery', 'uxde_script', array(
                                    'post_id' => $post->ID,
