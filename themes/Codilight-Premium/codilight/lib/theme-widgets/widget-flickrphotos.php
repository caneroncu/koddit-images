...
/* ==  Widget Setup ==============================*/
	...
	function UXDE_Flickr(){
		...
		$control_ops = array( 'id_base' => 'uxde_flickr_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'uxde_flickr_widget', __('UXDE - Flickr Widget', 'uxde'), $widget_ops, $control_ops );
	}
...
/* ==  Widget Settings ==============================*/
	...
	function form( $instance ) {
		...
		<p>
            <label for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e('Flickr ID:', 'uxde'); ?></label>
            ...
            <br /><span class="helper"><?php _e('Look your ID here,', 'uxde'); ?> <a href="http://idgettr.com" target="_blank">idGettr</a>.</span>
        </p>
		...
		<p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>">
               <?php _e('Number of Photos:', 'uxde'); ?>
                ...
                <br /><span class="helper"><?php _e('Up to 10 photos allowed.', 'uxde'); ?></span>
        </p>
