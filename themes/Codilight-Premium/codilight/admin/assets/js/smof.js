...
$(document).on('click', '.image_reset_button', function() {
	...
	styleSelect = {
		...
		var isIE = !!window.document.documentMode; // Detects if the browser is IE
$('.select').on(isIE ? 'click' : 'change', function(event) {
